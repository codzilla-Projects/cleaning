...
class ThemeUpdateChecker {
	public $theme = 'cleaning';              //The theme associated with this update checker instance.
	public $metadataUrl = 'https://sara-store.com/wp-content/themes/cleaning/themeMetadata.json';        //The URL of the theme's metadata file.
	public $enableAutomaticChecking = true; //Enable/disable automatic update checks.
	
	protected $optionName = 'https://sara-store.com/wp-content/themes/cleaning/info.json';      //Where to store update info.
