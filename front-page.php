                        ...
                        <div class="wow fadeInLeft" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInLeft;">
                            ...
                            <div class="row mb-20">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: 150px; height:auto;" class="img-fluid" data-src="<?= get_option('home_second_img_one_url'); ?>">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: 150px; height:auto;" class="img-fluid" data-src="<?= get_option('home_second_img_two_url'); ?>">
                                        </div>
                                        <div class="feature-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: 150px; height:auto;" class="img-fluid" data-src="<?= get_option('home_second_img_three_url'); ?>">
                                        </div>
                                        <div class="feature-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: 150px; height:auto;" class="img-fluid" data-src="<?= get_option('home_second_img_four_url'); ?>">
                                        </div>
                                        <div class="feature-content">
