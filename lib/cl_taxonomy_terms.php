...
add_action( 'category_add_form_fields', 'add_series_image_field', 10, 2 );
...
add_action( 'category_edit_form_fields', 'journey_series_edit_meta_field', 10, 2 );
...
add_action( 'edited_category', 'save_series_custom_meta', 10, 2 );  
add_action( 'create_category', 'save_series_custom_meta', 10, 2 );