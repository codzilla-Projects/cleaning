  ...
  $('.dropdown-toggle').click(
    function(){
      if ($(this).next().is(':visible')) {
        ...
        //Services Popup
    if($('#services-popup').length){
        
        //Show Popup
        $('.services-box-btn').on('click', function() {
            $('#services-popup').addClass('popup-visible');
        });
        $(document).keydown(function(e){
            if(e.keyCode == 27) {
                $('#services-popup').removeClass('popup-visible');
            }
        });
        //Hide Popup
        $('.close-search,.services-popup .overlay-layer').on('click', function() {
            $('#services-popup').removeClass('popup-visible');
        });
    }
      // get the inputs
      ...
      function handleUpdate(e) {
        ...
        const suffix = (this.id === 'cl_primaryColor' ? '' : 'px');
